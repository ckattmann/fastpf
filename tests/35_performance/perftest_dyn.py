"""
Performance measurements with a different number of loads for every method
"""
...
methods_loads_map = {1: 5000, 2: 5000, 3: 1000, 4: 100000, 5: 5000000, 6: 8000000}

grid = powerflow.data.mockgrids.feeder(nodes)
S = powerflow.data.mockloads.beta(
    grid, maxload=5000, numberofloads=methods_loads_map[method], seed=4268376
)
...
if method == 1:
    ...
    U, iters, runtime = powerflow.ybusgaussseidel(
        grid, S, verbose=False, acc_factor=1.0
    )
elif method == 3:
